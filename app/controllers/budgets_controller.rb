class BudgetsController < ApplicationController
  ...
  def create
    ...
    items_data = JSON.parse(params[:budget][:items_data]) if params[:budget][:items_data]
    Rails.logger.info items_data
  ...
  private
    ...
    def budget_params
      params.require(:budget).permit(:name, :description, :total, :margin)
    end
end
